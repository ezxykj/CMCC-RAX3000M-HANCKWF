...
sed -i 's/192.168.6.1/192.168.18.1/g' package/base-files/files/bin/config_generate
...
sed -i 's/TARGET_DEVICES += h3c_nx30pro/TARGET_DEVICES += h3c_nx30pro-112m/' target/linux/mediatek/image/mt7981.mk
